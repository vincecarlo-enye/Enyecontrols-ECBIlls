...
export default function DashboardCard({
  ...
  return (
    <div
      onClick={onClick}
      className={[
        "relative min-w-0 overflow-hidden rounded-[22px] p-4",
    ...
    >
      ...
      <p className="mb-1.5 break-words text-[10px] font-mono uppercase tracking-[0.16em] text-slate-500 leading-tight dark:text-slate-500">
        {title}
      </p>

      <p className="break-words text-xl font-bold leading-none text-slate-800 dark:text-slate-50 sm:text-[1.35rem]">
        {value}
      </p>
