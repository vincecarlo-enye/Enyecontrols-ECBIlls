...
export default function SummaryCardStrip({
  ...
  return (
    <div className={`relative min-w-0 ${className}`.trim()}>
      ...
      <div ref={scrollRef} className={stretch ? 'min-w-0 pb-3' : 'modern-scroll-strip min-w-0 overflow-x-auto pb-3'}>
        <div className={`${stretch ? `grid min-w-0 w-full ${stretchGridClass}` : 'flex min-w-max'} ${gapClassName}`.trim()}>
