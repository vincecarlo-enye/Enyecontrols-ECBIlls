...
import { CheckCircle2, Eye, Filter, Receipt, Search, X, XCircle } from 'lucide-react'
    ...
    <div className="space-y-5 animate-in min-w-0">
      <PageSection>
        <PageHeader
          ...
          subtitle="Review adjustment history, approval requests, and applied bill changes."
          icon={Receipt}
        />
      </PageSection>
      ...
      <div className="bg-white dark:bg-slate-900 border border-slate-200/70 dark:border-slate-700/50 rounded-2xl p-3 sm:p-4 shadow-sm flex flex-col sm:flex-row gap-3 sm:items-center">
        ...
        <select
          ...
          className="w-full sm:w-auto px-3 py-2.5 text-sm rounded-xl bg-slate-50 dark:bg-slate-800/60 border border-slate-200 dark:border-slate-700 text-slate-700 dark:text-slate-200 outline-none"
        >
            ...
            <tbody className="divide-y divide-slate-100 dark:divide-slate-800">
              {loading ? (
                ...
                <tr>
                  <td colSpan={12}>
                    <EmptyState
                      title="No bill adjustments found"
                      message="Adjustment requests and history will appear here."
                    />
                  </td>
                </tr>
              ) : (
